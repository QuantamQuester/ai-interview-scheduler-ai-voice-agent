...
export default function Interview() {
    ...
    <div className='px-10 md:px-28 lg:px-48 xl:px-64 mt-16 '>
        <div className='flex flex-col items-center p-7 justify-center border rounded-lg bg-white lg:px-32 xl:px-52 mb-20'>
            <Image src={'/logo.png'} alt="logo" width={200} height={200}
            className='w-[140px]'/>
            <h2 className='font-bold' >AI-Powered Interview Platform</h2>
            <Image  src={'/interview.png'} alt='interview' width={300} height={300} className='e-[350px]'/>
            ...
            <div className='p-3 bg-blue-100 flex gap-4 rounded-lg mt-7' >
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li className='text-sm text-primary'>Ensure you have a stable interne Connection</li>
            ...
            <Button className='mt-5 w-full font-bold' disabled={loading==true || !userName}
...
// http://localhost:3000/interview/f77782c0-985f-4e7d-a4e0-6609b47a369c